...
export function Skills({ locale }: SkillsProps) {
  ...
  return (
    <section id="skills" className="relative py-28 lg:py-36 bg-[#FAF9F6] dark:bg-[#0B0B0C]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <SectionReveal key={activeCategory} delay={0.1}>
          <div className="max-w-4xl mx-auto p-8 lg:p-12 rounded-2xl bg-white dark:bg-[#121214] border border-[#E4E4E7] dark:border-[#1F1F24] shadow-xl">
            <div className="flex items-center gap-4 mb-8 pb-6 border-b border-[#E4E4E7] dark:border-[#1F1F24]">
